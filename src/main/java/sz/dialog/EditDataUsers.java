 ...
 * @author ADVAN
 */
public class EditDataUsers extends javax.swing.JFrame {
     Pegawai Pg;

    public EditDataUsers(Pegawai pg) {
        initComponents();
...
private void isiForm() {
    txtNama.setText(Pg.getNp());
    cmbJabatan.setSelectedItem(Pg.getJabatan());
    txtUsername.setText(Pg.getUnam());
    txtPassword.setText(Pg.getPgw());
}

    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(EditDataUsers.class.getName());

    /**
     * Creates new form EditDataUsers
     */
    public EditDataUsers() {
        initComponents();
    }
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cmbJabatan, 0, 242, Short.MAX_VALUE)
    ...
    try {
            ...
            String sql = "UPDATE pegawai SET nama_pegawai=?, jabatan=?, username_p=?, password_hash=? WHERE id_pegawai=?";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new EditDataUsers().setVisible(true));
    }
